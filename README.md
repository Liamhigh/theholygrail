...
├── assets.zip                 # Logo and image assets (extracted during build)
├── public/                    # Static assets (assets/ and videos/ added during build)
├── capacitor.config.json      # Capacitor configuration
├── firebase.json              # Firebase Hosting configuration
├── index.html                 # Main HTML entry point
├── package.json
├── BUILD_ASSETS.md           # Documentation for build assets and videos
...
For details on how assets and videos are included in builds, see **[BUILD_ASSETS.md](BUILD_ASSETS.md)**.
...
- `/dist/assets/` - Logo images from assets.zip
- `/dist/videos/` - Video files from videos/ directory
